...
//    TGAImage framebuffer(width, height, TGAImage::RGB);
    ...
    drop_zbuffer(OUTPUT_PATH"zbuffer1.tga", zbuffer, width, height);
    ...
    { // shadow rendering pass
        ...
        trash.write_tga_file(OUTPUT_PATH"shadowmap.tga");
    }

    drop_zbuffer(OUTPUT_PATH"zbuffer2.tga", zbuffer, shadoww, shadowh);
    ...
    maskimg.write_tga_file(OUTPUT_PATH"mask.tga");
    ...
    framebuffer.write_tga_file(OUTPUT_PATH"shadow.tga");
