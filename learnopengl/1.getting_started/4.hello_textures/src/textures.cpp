...
int main() {
    ...
    // ------------------------------------
    Shader ourShader("../../../../assets/1.4.texture.vs",
                     "../../../../assets/1.4.texture.fs");
    ...
    unsigned char *data = stbi_load("../../../../assets/container.jpg", &width,
                                    &height, &nrChannels, 0);
    if (data) {
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
    // load image, create texture and generate mipmaps
    data = stbi_load("../../../../assets/awesomeface.png", &width, &height,
                     &nrChannels, 0);
    if (data) {
...
void processInput(GLFWwindow *window) {
    ...
    if (glfwGetKey(window, GLFW_KEY_UP) == GLFW_PRESS) {
        mixValue += 0.001f; // change this value accordingly (might be too slow
